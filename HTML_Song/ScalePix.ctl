...
Public Property Get ImageHeight() As Long
       ImageHeight = imgActual.Height \ Screen.TwipsPerPixelY
End Property
Public Property Get ImageWidth() As Long
       ImageWidth = imgActual.Width \ Screen.TwipsPerPixelX
End Property
...
Private Sub imgActual_Click()
    RaiseEvent Click

End Sub

Private Sub imgSized_Click()
    RaiseEvent Click
